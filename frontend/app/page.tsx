          ...
          <div className="grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 content-start">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <button
                        ...
                        className="flex items-center gap-1.5 text-[0.75rem] font-bold text-[#7C3AED] hover:opacity-70 transition-opacity"
                      >
                      ...
                      >
                        <svg className="w-3.5 h-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347z"/><path d="M12 0C5.373 0 0 5.373 0 12c0 2.116.551 4.099 1.518 5.829L.057 23.428a.5.5 0 0 0 .514.572l5.762-1.506A11.94 11.94 0 0 0 12 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.907 0-3.686-.506-5.218-1.387l-.374-.218-3.876 1.013 1.032-3.765-.235-.388A9.974 9.974 0 0 1 2 12C2 6.477 6.477 2 12 2s10 4.477 10 10-4.477 10-10 10z"/></svg>
                        WA
                      </a>
                      {/* Telegram */}
                      <a
              ...
              {activityFeed.length > 0 && (
                <div className="md:col-span-2">
                  <SectionLabel color="#22C55E">Community Activity</SectionLabel>
                  <Card>
                    <CardContent>
                      {activityFeed.map((entry) => (
                        <CardRow key={entry.txHash}>
                          <div className="flex items-center gap-3">
                            <RowIcon bg="bg-[#DCFCE7]">
                          ...
                          <span className="font-sans text-[0.7rem] text-[#09090B]/35">
